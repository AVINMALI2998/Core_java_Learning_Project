...
public class SeleniumCheatSheet {
    public static void main(String[] args) {
        System.out.println("Selenium cheat sheet");
        ...
        // driver.findElement(By.partialLinkText("Next")).click(); // By Partial Link
        // Text
        ...
        // Set<String> handles = driver.getWindowHandles(); // Switch to newly created
        // window
        ...
        // driver.getElementById("field").setAttribute("disabled", "true"); // Disable
        // field (requires JS execution)
        // driver.getElementById("field").removeAttribute("disabled"); // Enable field
        ...
        // // Start Node
        // java -jar selenium-server-standalone-x.x.x.jar -role node -hub
